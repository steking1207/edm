...
if ((endsWith($_SESSION['page_url'], $end) === false) && ($_SESSION['page_url'] !== $website . "/")){
    $_SESSION['page_url'] = $website . $_SERVER[REQUEST_URI];
    $_SESSION['page_data'] = $_SESSION['page_url'];
}

// var_dump(endsWith($_SERVER[REQUEST_URI], $end));
// var_dump(($_SESSION['page_url'] !== $website . "/"));
...
if (!isset($_SESSION['nav_history'])){
    ...
    $history = array_slice($_SESSION['nav_history'], -3, 3);
